...
class MotorGui(Node):
    ...
    def __init__(self):
        ...
        self.mot_1_left_enc = Label(enc_frame, text="0")
        self.mot_1_left_enc.pack(side=LEFT)
        self.mot_2_left_enc = Label(enc_frame, text="0")
        self.mot_2_left_enc.pack(side=LEFT)
        
        self.mot_1_right_enc = Label(enc_frame, text="0")
        self.mot_1_right_enc.pack(side=LEFT)
        self.mot_2_right_enc = Label(enc_frame, text="0")
        self.mot_2_right_enc.pack(side=LEFT)
        ...
        self.mot_1_left_lbl = Label(enc_frame, text="0")
        self.mot_1_left_lbl.pack(side=LEFT)
        
        self.mot_2_left_lbl = Label(enc_frame, text="0")
        self.mot_2_left_lbl.pack(side=LEFT)
        
        self.mot_1_right_lbl = Label(enc_frame, text="0")
        self.mot_1_right_lbl.pack(side=LEFT)
        
        self.mot_2_right_lbl = Label(enc_frame, text="0")
        self.mot_2_right_lbl.pack(side=LEFT)
    ...
    def motor_vel_callback(self, motor_vels):
        mot_1_left_rev_sec = motor_vels.mot_1_left_sec
        mot_2_left_rev_sec = motor_vels.mot_2_left_sec
        mot_1_right_rev_sec = motor_vels.mot_1_right_sec
        mot_2_right_rev_sec = motor_vels.mot_2_right_sec
        
        self.mot_1_left_lbl.config(text=f"{mot_1_left_rev_sec:.2f}")
        self.mot_2_left_lbl.config(text=f"{mot_2_left_rev_sec:.2f}")
        
        self.mot_1_right_lbl.config(text=f"{mot_1_right_rev_sec:.2f}")
        self.mot_2_right_lbl.config(text=f"{mot_2_right_rev_sec:.2f}")

    def encoder_val_callback(self, encoder_vals):
        
        mot_1_left_rev_sec = encoder_vals.mot_1_left_en
        mot_2_left_rev_sec = encoder_vals.mot_2_left_en
        mot_1_right_rev_sec = encoder_vals.mot_1_right_en
        mot_2_right_rev_sec = encoder_vals.mot_2_right_en
        
        self.mot_1_left_enc.config(text=f"{mot_1_left_rev_sec:.2f}")
        self.mot_2_left_enc.config(text=f"{mot_2_left_rev_sec:.2f}")
        self.mot_1_right_enc.config(text=f"{mot_1_right_rev_sec:.2f}")
        self.mot_2_right_enc.config(text=f"{mot_2_right_rev_sec:.2f}")
    ...
    def update_scale_limits(self):
        if (self.pwm_mode):
            self.m1.config(from_=-40, to=40, resolution=1)
            self.m2.config(from_=-40, to=40, resolution=1)
        else:
